...
  const handleNavClick = useCallback((path?: string) => {
    // This line is the fix: it clears the open dropdown state.
    setOpenDropdown(new Set<string>());

    if (path) {
      handleNavigation(path);
    }
  }, [handleNavigation, setOpenDropdown]); // Add setOpenDropdown to dependency array
  // ▲▲▲ THIS IS THE CORRECTED FUNCTION ▲▲▲
